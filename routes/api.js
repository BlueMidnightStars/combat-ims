...
// 文章管理
// 获取所有文章
router.get('/article', titlecontroller.alltitle);
// 获取指定分类id下的文章
// router.get('/article?classify_id:id', titlecontroller.class_idTitle);
// 获取指定id的文章
router.get('/article/:id', titlecontroller.id_title_content);
// 添加文章
router.post('/article', titlecontroller.add_title_content);
// 修改文章
router.put('/article:id', titlecontroller.update_title_content);
// 删除文章
router.delete('/article:id', titlecontroller.delete_title_content);
